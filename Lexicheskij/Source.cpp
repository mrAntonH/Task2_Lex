...
private:
	...
	int priority;
	string classOf;
	vector<string> InIt; // если элементы €вл€ютс€ строками
	vector<char> one; // если элементы €вл€ютс€ символами
public:
...
void lex (vector<Automat*> M) { // главна€ функци€,на вход подаетс€ набор автоматов
	string w;
